...
a persistence unit "SistemaTransacionesPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "SistemaTransaciones\pom.xml":
...
artifact ("SistemaTransaciones.war") is already built. You can build
