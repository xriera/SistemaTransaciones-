...
//		p.setNombre("juan");
//		p.setCorreo("juan@hotmail.com");
//		p.setClave("cuenca");
//		on.crearPersona(p);
//
//		Persona p1 = new Persona();
//		p1.setNombre("cristina");
//		p1.setCorreo("cristina@gmail.com");
//		p1.setClave("cuenca");
//		on.crearPersona(p1);
//
//		Persona p2 = new Persona();
//		p2.setNombre("melissa");
//		p2.setCorreo("melissa@gmail.com");
//		p2.setClave("cuenca");
//		on.crearPersona(p2);
		...
		admi2.setNombre("Cristina");
		admi2.setApellido("Espinoza");
		admi2.setUsuario("cespinoza");
		...
		Rol rol3 = new Rol();
		rol3.setNombre("Asist. de capacitaciones");
